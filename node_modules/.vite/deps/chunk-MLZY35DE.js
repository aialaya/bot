...
var CaipNetworksUtil = {
  ...
  extendCaipNetwork(caipNetwork, { customNetworkImageUrls, projectId, customRpc }) {
    ...
    let rpcUrl = "";
    if (customRpc) {
      rpcUrl = ((_a = caipNetwork.rpcUrls.default.http) == null ? void 0 : _a[0]) || "";
    } else {
...
var AdapterBlueprint = class {
  ...
  setUniversalProvider(universalProvider) {
    this.addConnector({
      ...
      imageId: PresetsUtil.ConnectorImageIds[ConstantsUtil.CONNECTOR_ID.WALLET_CONNECT],
  ...
  addConnector(...connectors) {
    var _a, _b;
    if (connectors.some((connector) => connector.id === ConstantsUtil.CONNECTOR_ID.AUTH)) {
      const authConnector = connectors.find((connector) => connector.id === ConstantsUtil.CONNECTOR_ID.AUTH);
...
var AppKit = class {
  ...
  async open(options) {
    await this.initOrContinue();
    if ((options == null ? void 0 : options.uri) && this.universalAdapter) {
  ...
  createClients() {
    this.connectionControllerClient = {
      connectWalletConnect: async (onUri) => {
        ...
        (_a = this.universalProvider) == null ? void 0 : _a.on("display_uri", onUri);
  ...
  async listenAuthConnector(provider) {
    ...
    provider.onRpcSuccess((_, request) => {
      ...
      if (this.isTransactionStackEmpty()) {
        this.close();
        if (AccountController.state.address && ((_a2 = ChainController.state.activeCaipNetwork) == null ? void 0 : _a2.id)) {
          this.updateBalance();
        }
      } else {
        this.popTransactionStack();
        if (AccountController.state.address && ((_b2 = ChainController.state.activeCaipNetwork) == null ? void 0 : _b2.id)) {
          this.updateBalance();
        }
      }
    });
    ...
    provider.onConnect(async (user) => {
      ...
      const userAccounts = (_a2 = user.accounts) == null ? void 0 : _a2.map((account) => CoreHelperUtil.createAccount(namespace, account.address, namespace === "eip155" ? account.type : "eoa"));
  ...
  async syncAccount({ address, chainId, chainNamespace }) {
    ...
    if ((address == null ? void 0 : address.toLowerCase()) !== ((_a = AccountController.state.address) == null ? void 0 : _a.toLowerCase())) {
    ...
    if (chainIdToUse && chainNamespace === activeNamespace) {
      const caipNetwork = (_b = this.caipNetworks) == null ? void 0 : _b.find((n) => n.id.toString() === chainIdToUse.toString());
      const fallBackCaipNetwork = (_c = this.caipNetworks) == null ? void 0 : _c.find((n) => n.chainNamespace === chainNamespace);
  ...
  createAuthProvider() {
    ...
    if (!this.authProvider && ((_j = this.options) == null ? void 0 : _j.projectId) && (isEmailEnabled || isSocialsEnabled)) {
  ...
  async initOrContinue() {
    if (!this.initPromise && !isInitialized && CoreHelperUtil.isClient()) {
      ...
      this.initPromise = new Promise(async (resolve) => {
        await Promise.all([
          import("./esm-B7PHG2YF.js"),
          import("./w3m-modal-C34SZXIL.js")
        ]);
...
var W3mAccountSettingsView = class W3mAccountSettingsView2 extends LitElement {
  ...
  togglePreferredAccountBtnTemplate() {
    ...
    const connectorId = StorageUtil.getConnectedConnectorId();
    const authConnector = ConnectorController.getAuthConnector();
    if (!authConnector || connectorId !== ConstantsUtil.CONNECTOR_ID.AUTH || !networkEnabled) {
      return null;
    }
    if (!this.switched) {
...
var W3mConnectView = class W3mConnectView2 extends LitElement {
  ...
  renderConnectMethod(tabIndex) {
    ...
    return html`${connectMethodsOrder.map((method, index2) => {
      switch (method) {
        case "email":
          return html`${this.emailTemplate(tabIndex)} ${this.separatorTemplate(index2, "email")}`;
        case "social":
  ...
  checkMethodEnabled(name) {
    ...
    switch (name) {
      ...
      case "social":
        return ((_a = this.features) == null ? void 0 : _a.socials) && ((_b = this.features) == null ? void 0 : _b.socials.length) > 0;
      case "email":
        return (_c = this.features) == null ? void 0 : _c.email;
      default:
        return null;
    }
  }
  ...
  separatorTemplate(index2, type) {
    ...
    switch (type) {
      ...
      case "email": {
        const isEmailEnabled = (_a = this.features) == null ? void 0 : _a.email;
      ...
      case "social": {
        const isSocialEnabled = ((_b = this.features) == null ? void 0 : _b.socials) && ((_c = this.features) == null ? void 0 : _c.socials.length) > 0;
  ...
  emailTemplate(tabIndex) {
    var _a;
    const emailEnabled = (_a = this.features) == null ? void 0 : _a.email;
  ...
  socialListTemplate(tabIndex) {
    var _a, _b;
    const isSocialsEnabled = ((_a = this.features) == null ? void 0 : _a.socials) && ((_b = this.features) == null ? void 0 : _b.socials.length) > 0;
    const isCreateWalletPage = this.walletGuide === "explore";
  ...
  walletListTemplate(tabIndex) {
    var _a, _b, _c, _d;
    const enableWallets = this.enableWallets;
    const collapseWalletsOldProp = ((_a = this.features) == null ? void 0 : _a.emailShowWallets) === false;
    const collapseWallets = (_b = this.features) == null ? void 0 : _b.collapseWallets;
    ...
    const hasEmail = (_c = this.features) == null ? void 0 : _c.email;
    const hasSocials = ((_d = this.features) == null ? void 0 : _d.socials) && this.features.socials.length > 0;
...
var W3mNetworksView = class W3mNetworksView2 extends LitElement {
  ...
  onSwitchNetwork(network) {
    ...
    const isAuthConnected = StorageUtil.getConnectedConnectorId() === ConstantsUtil.CONNECTOR_ID.AUTH;
...
var W3mConnectingWcQrcode = class W3mConnectingWcQrcode2 extends W3mConnectingWidget {
  ...
  render() {
    ...
    return html`
      ...
      <w3m-mobile-download-links .wallet=${this.wallet}></w3m-mobile-download-links>
      ${this.useInjectedUniversalProvider ? html`<wui-flex flexDirection="column" .padding=${["0", "xl", "xl", "xl"]} gap="xl">
            <w3m-all-wallets-widget></w3m-all-wallets-widget>
          </wui-flex>` : null}
    `;
  }
  ...
  btcAccountsTemplate() {
    return html`<wui-flex gap="m" alignItems="center" flexDirection="column">
      ...
      <wui-tabs
        ...
        .onTabChange=${(index2) => {
      var _a;
      return AccountController.setCaipAddress(`bip122:${this.chainId}:${((_a = this.allAccounts[index2]) == null ? void 0 : _a.address) || ""}`, this.namespace);
    }}
      ></wui-tabs>
...
var W3mConnectorList = class W3mConnectorList2 extends LitElement {
  ...
  render() {
    const { custom: custom2, recent, announced, injected, multiChain, recommended, featured, external } = ConnectorUtil.getConnectorsByType(this.connectors);
...
//# sourceMappingURL=chunk-MLZY35DE.js.map
