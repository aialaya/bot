import {
  ...
  init_lib10 as init_lib21,
  init_lib2 as init_lib13,
  init_lib3 as init_lib14,
  init_lib4 as init_lib15,
  init_lib5 as init_lib16,
  init_lib6 as init_lib17,
  init_lib7 as init_lib18,
  init_lib8 as init_lib19,
  init_lib9 as init_lib20,
  lib_exports as lib_exports12,
  lib_exports10 as lib_exports21,
  lib_exports11 as lib_exports22,
  lib_exports2 as lib_exports13,
  lib_exports3 as lib_exports14,
  lib_exports4 as lib_exports15,
  lib_exports5 as lib_exports16,
  lib_exports6 as lib_exports17,
  lib_exports7 as lib_exports18,
  lib_exports8 as lib_exports19,
  lib_exports9 as lib_exports20
} from "./chunk-VAYXZY56.js";
import {
  AdapterBlueprint,
...
var require_utils2 = __commonJS({
  "node_modules/ethers/lib/utils.js"(exports) {
    ...
    var base64 = __importStar((init_lib5(), __toCommonJS(lib_exports5)));
    ...
    var properties_1 = (init_lib8(), __toCommonJS(lib_exports8));
    ...
    var strings_1 = (init_lib4(), __toCommonJS(lib_exports4));
    ...
    var strings_2 = (init_lib4(), __toCommonJS(lib_exports4));
...
var SHA256 = class extends HashMD {
  ...
  get() {
    const { A: A2, B: B2, C: C4, D: D2, E: E2, F: F2, G, H } = this;
    return [A2, B2, C4, D2, E2, F2, G, H];
  }
  // prettier-ignore
  set(A2, B2, C4, D2, E2, F2, G, H) {
    this.A = A2 | 0;
    this.B = B2 | 0;
    this.C = C4 | 0;
    this.D = D2 | 0;
  ...
  process(view, offset) {
    ...
    let { A: A2, B: B2, C: C4, D: D2, E: E2, F: F2, G, H } = this;
    for (let i3 = 0; i3 < 64; i3++) {
      const sigma1 = rotr(E2, 6) ^ rotr(E2, 11) ^ rotr(E2, 25);
      const T1 = H + sigma1 + Chi(E2, F2, G) + SHA256_K[i3] + SHA256_W[i3] | 0;
    ...
    G = G + this.G | 0;
    H = H + this.H | 0;
    this.set(A2, B2, C4, D2, E2, F2, G, H);
  }
  roundClean() {
    SHA256_W.fill(0);
  }
...
function P(n2, l3, u3, t3, i3, o3, r4, f3, e3, c3, s3) {
  ...
  for (u3.__d = e3, $(u3, l3, _2), e3 = u3.__d, a3 = 0; a3 < g2; a3++) null != (y3 = u3.__k[a3]) && (p3 = -1 === y3.__i ? h : _2[y3.__i] || h, y3.__i = a3, O(n2, y3, p3, i3, o3, r4, f3, e3, c3, s3), d3 = y3.__e, y3.ref && p3.ref != y3.ref && (p3.ref && E(p3.ref, null, y3), s3.push(y3.ref, y3.__c || d3, y3)), null == w3 && null != d3 && (w3 = d3), 65536 & y3.__u || p3.__k === y3.__k ? e3 = I(y3, e3, n2) : "function" == typeof y3.type && void 0 !== y3.__d ? e3 = y3.__d : d3 && (e3 = d3.nextSibling), y3.__d = void 0, y3.__u &= -196609);
  u3.__d = e3, u3.__e = w3;
}
function $(n2, l3, u3) {
...
function O(n2, u3, t3, i3, o3, r4, f3, e3, c3, s3) {
  var a3, h3, v3, p3, w3, _2, g2, m2, x2, C4, S2, M2, $2, I2, H, L2, T2 = u3.type;
  if (void 0 !== u3.constructor) return null;
  128 & t3.__u && (c3 = !!(32 & t3.__u), r4 = [e3 = u3.__e = t3.__e]), (a3 = l.__b) && a3(u3);
  n: if ("function" == typeof T2) try {
    if (m2 = u3.props, x2 = "prototype" in T2 && T2.prototype.render, C4 = (a3 = T2.contextType) && i3[a3.__c], S2 = a3 ? C4 ? C4.props.value : a3.__ : i3, t3.__c ? g2 = (h3 = u3.__c = t3.__c).__ = h3.__E : (x2 ? u3.__c = h3 = new T2(m2, S2) : (u3.__c = h3 = new k(m2, S2), h3.constructor = T2, h3.render = V), C4 && C4.sub(h3), h3.props = m2, h3.state || (h3.state = {}), h3.context = S2, h3.__n = i3, v3 = h3.__d = true, h3.__h = [], h3._sb = []), x2 && null == h3.__s && (h3.__s = h3.state), x2 && null != T2.getDerivedStateFromProps && (h3.__s == h3.state && (h3.__s = d({}, h3.__s)), d(h3.__s, T2.getDerivedStateFromProps(m2, h3.__s))), p3 = h3.props, w3 = h3.state, h3.__v = u3, v3) x2 && null == T2.getDerivedStateFromProps && null != h3.componentWillMount && h3.componentWillMount(), x2 && null != h3.componentDidMount && h3.__h.push(h3.componentDidMount);
    else {
...
function z(u3, t3, i3, o3, r4, f3, e3, c3, s3) {
  var a3, v3, p3, d3, _2, g2, m2, b2 = i3.props, k3 = t3.props, C4 = t3.type;
  if ("svg" === C4 ? r4 = "http://www.w3.org/2000/svg" : "math" === C4 ? r4 = "http://www.w3.org/1998/Math/MathML" : r4 || (r4 = "http://www.w3.org/1999/xhtml"), null != f3) {
    for (a3 = 0; a3 < f3.length; a3++) if ((_2 = f3[a3]) && "setAttribute" in _2 == !!C4 && (C4 ? _2.localName === C4 : 3 === _2.nodeType)) {
      u3 = _2, f3[a3] = null;
      break;
    }
  }
  if (null == u3) {
    ...
    u3 = document.createElementNS(r4, C4, k3.is && k3), c3 && (l.__m && l.__m(t3, f3), c3 = false), f3 = null;
  }
  if (null === C4) b2 === k3 || c3 && u3.data === k3 || (u3.data = k3);
    ...
    else if (p3 && (u3.innerHTML = ""), P(u3, y(d3) ? d3 : [d3], t3, i3, o3, "foreignObject" === C4 ? "http://www.w3.org/1999/xhtml" : r4, f3, e3, f3 ? f3[0] : i3.__k && x(i3, 0), c3, s3), null != f3) for (a3 = f3.length; a3--; ) w(f3[a3]);
    c3 || (a3 = "value", "progress" === C4 && null == g2 ? u3.removeAttribute("value") : void 0 !== g2 && (g2 !== u3[a3] || "progress" === C4 && !g2 || "option" === C4 && g2 !== b2[a3]) && A(u3, a3, g2, b2[a3], r4), a3 = "checked", void 0 !== m2 && m2 !== u3[a3] && A(u3, a3, m2, b2[a3], r4));
  }
  return u3;
}
function E(n2, u3, t3) {
...
c2.__b = function(n2) {
  ...
  })) : (i3.__h.forEach(z2), i3.__h.forEach(B), i3.__h = [], t2 = 0)), u2 = r3;
...
// node_modules/@reown/appkit-adapter-ethers5/dist/esm/src/utils/Ethers5Methods.js
var Ethers5Methods = {
  signMessage: async (message, provider, address) => {
    if (!provider) {
      throw new Error("signMessage - provider is undefined");
    }
    const hexMessage = ethers_exports.utils.isHexString(message) ? message : ethers_exports.utils.hexlify(ethers_exports.utils.toUtf8Bytes(message));
  ...
  estimateGas: async (data, provider, address, networkId) => {
    ...
    const browserProvider = new ethers_exports.providers.Web3Provider(provider, networkId);
  ...
  sendTransaction: async (data, provider, address, networkId) => {
    ...
    return (txReceipt == null ? void 0 : txReceipt.blockHash) || null;
  },
  writeContract: async (data, provider, address, chainId) => {
    ...
    const browserProvider = new ethers_exports.providers.Web3Provider(provider, chainId);
    const signer = browserProvider.getSigner(address);
  ...
  parseUnits: (value, _2) => ethers_exports.utils.parseUnits(value, "gwei").toBigInt(),
  formatUnits: ethers_exports.utils.formatUnits
};

// node_modules/@reown/appkit-adapter-ethers5/dist/esm/src/client.js
var import_utils6 = __toESM(require_utils2(), 1);
var Ethers5Adapter = class extends AdapterBlueprint {
  constructor() {
    super({});
  ...
  async writeContract(params) {
    ...
    const result = await Ethers5Methods.writeContract(params, params.provider, params.caipAddress, Number((_a = params.caipNetwork) == null ? void 0 : _a.id));
    return { hash: result };
  }
  ...
  syncConnectors(options) {
    ...
    connectors.forEach((connector) => {
      ...
      const injectedConnector = connector === ConstantsUtil.CONNECTOR_ID.INJECTED;
      if (this.namespace) {
        this.addConnector({
          id: key,
          ...
          info: injectedConnector ? void 0 : { rdns: key },
  ...
  async getAccounts(params) {
    const connector = this.connectors.find((c3) => c3.id === params.id);
    const selectedProvider = connector == null ? void 0 : connector.provider;
  ...
  async getBalance(params) {
    ...
    if (caipNetwork) {
      const jsonRpcProvider = new lib_exports20.JsonRpcProvider(caipNetwork.rpcUrls.default.http[0], {
      ...
      if (jsonRpcProvider) {
        try {
          ...
          const formattedBalance = (0, import_utils6.formatEther)(balance);
  ...
  async getProfile(params) {
    if (params.chainId === 1) {
      const ensProvider = new lib_exports20.InfuraProvider("mainnet");
...
@noble/hashes/esm/utils.js:
  (*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=@reown_appkit-adapter-ethers5.js.map
